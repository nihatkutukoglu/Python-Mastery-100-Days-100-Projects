# 🐍 100 Gün Python Geliştirme: Projelerle Python Öğreniyorum
...
* **Projeler:**
    * 9. Gün: Kişi rehberi: sözlükler (dictionaries) ✅
    * 10. Gün: Malzeme kontrolü: demetler ve kümeler ✅
    * 11. Gün: Not alma uygulaması: dosya işlemleri ✅
    * 12. Gün: Güvenli hesap makinesi: hata yakalama (try-except) ✅
...
* **Projeler:**
    * 16. Gün: Tarife görüntüleyici: dosya okuma ✅
    * 17. Gün: Günlük kaydedici: dosya yazma
    * 18. Gün: Öğrenci raporu oluşturucu: CSV dosyaları
    * 19. Gün: Mini yapılacaklar listesi: JSON dosyaları
...
* **Projeler:**
    * 23. Gün: Banka hesabı simülasyonu: sınıflar ve nesneler
    * 24. Gün: Kütüphane yönetim sistemi: yapıcılar ve metotlar
    * 25. Gün: Çalışan yönetimi: kalıtım (inheritance)
    * 26. Gün: Hayvan sesi simülatörü: çok biçimlilik (polymorphism)
...
* **Projeler:**
    * 30. Gün: Basit GUI uygulaması: Tkinter temelleri
    * 31. Gün: Tıklama sayacı: butonlar ve olaylar
    * 32. Gün: Vücut kitle indeksi hesaplayıcı: giriş alanları
    * 33. Gün: Çizim tahtası uygulaması: canvas widget'ları
...
* **Projeler:**
    * 37. Gün: Merhaba Flask: Flask temelleri
    * 38. Gün: Kişisel blog sitesi: yollar ve şablonlar
    * 39. Gün: İletişim formu uygulaması: formlar ve kullanıcı girişi
    * 40. Gün: Kullanıcı kayıt sistemi: veritabanı bağlantısı
...
* **Projeler:**
    * 44. Gün: Matris hesaplayıcı: NumPy
    * 45. Gün: Veri temizleyici: Pandas
    * 46. Gün: Grafik çizici: Matplotlib
    * 47. Gün: Satış raporu analizörü: veri analizi
...
* **Projeler:**
    * 51. Gün: Hava durumu panosu
    * 52. Gün: Harcama takipçisi
    * 53. Gün: Dosya düzenleyici
    * 54. Gün: Tic-Tac-Toe oyunu
    * 55. Gün: Mini sohbet botu
    * 56. Gün: Müzik listesi yöneticisi
    * 57. Gün: Kişisel bütçe planlayıcı
    * 58. Gün: ASCII sanat üretici
...
* **Projeler:**
    * 62. Gün: Sosyal medya verisi toplayıcı
    * 63. Gün: Otomatik yedekleme aracı
    * 64. Gün: Film öneri sistemi
    * 65. Gün: PDF birleştirici
    * 66. Gün: Portföy sitesi arka ucu
    * 67. Gün: Flashcard öğrenme uygulaması
    * 68. Gün: Borsa gösterge paneli
...
* **Projeler:**
    * 72. Gün: Spam e-posta tespit edici
    * 73. Gün: Metin duygu analizi
    * 74. Gün: El yazısı rakam tanıma
    * 75. Gün: Sesli asistan
    * 76. Gün: Yüz tanıma uygulaması
    * 77. Gün: Basit öneri sistemi
    * 78. Gün: NLP ile sohbet botu
